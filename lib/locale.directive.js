...
function install(Vue, options) {
    ...
    exports.formatCurrency = function (val) {
        var numberOptions = {
            style: "currency",
            currency: currency,
    ...
    exports.formatCurrencyPrecise = function (val) {
        return exports.formatNumber(val == undefined || val === "" || isNaN(val) ? 0 : val, "currency");
    };
    exports.formatPercent = function (val, fractionDigits) {
    ...
    exports.formatNumberToPrecision = function (val, fractionDigits) {
    ...
    var helpers = {
        ...
        formatCurrencyPrecise: exports.formatCurrencyPrecise,
        formatPercent: exports.formatPercent,
        formatNumberToPrecision: exports.formatNumberToPrecision
    };
